#ifndef KOHI_1700179095_INPUT_H
#define KOHI_1700179095_INPUT_H
...
// From ascii table
// TODO: Requires some platform specific changes to map different keys
typedef enum keys {
...
/*
is - current frame(state)
was - previous frame (state)
*/
// keyboard input
...
// will be called by platform system so not exposed
...
// Will be called by platform level
