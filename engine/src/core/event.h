#ifndef KOHI_1700107619_EVENT_H
#define KOHI_1700107619_EVENT_H

#include "defines.h"

// Designed to be stored on the stack
...
// Event handler -> will be assigned to
// pointer function on event
...
// Register the on_event pfn to the listener
/**
