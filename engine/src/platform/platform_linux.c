...
/*
Windowing system in Linux:
It is client-server architecture
x11 -> server portion
xlib (almost depracated ) and xcb(new) -> client portion
*/
#include <xcb/xcb.h>
...
b8 platform_startup(
    ...
    // This is global call around OS SO BAD
    ...
    // Loop through all available screens on the machine using iterator
    ...
    // Black color for the back screen
...
b8 platform_pump_messages(platform_state* plat_state) {
    ...
    while (event != 0) {
        ...
        // Input events
        // Extra layer of translation requires for unix and linux
