#ifndef KOHI_1701658769_KMATH_H
#define KOHI_1701658769_KMATH_H
...
/**
 * @brief Returns a matrix which contain a rotation for the angle_radians along the x direction
 */
...
/**
 * @brief Returns a matrix which contain a rotation for the angle_radians along the y direction
 */
...
/**
 * @brief Returns a matrix which contain a rotation for the angle_radians along the z direction
 */
...
// Obtain directions from matrices
// Matrices sort of store translation, scale and rotation info.
// Following functions extracts orientation from mat4 matrices.
// ------------------------------------------
/**
