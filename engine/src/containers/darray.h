#ifndef KOHI_1700108610_DARRAY_H
#define KOHI_1700108610_DARRAY_H
...
KAPI u64 _darray_field_get(void* array, u64 field /*offset within the memory layout*/);
...
// Macros handles the generic info for us
