...
void vulkan_renderpass_create(
    ...
    subpass.pipelineBindPoint = VK_PIPELINE_BIND_POINT_GRAPHICS;  // usage purpose of the subpass
    ...
    // specifies What to do when attachment is loaded
...
void vulkan_renderpass_begin(
    vulkan_command_buffer* command_buffer,  // renderpass needs command buffer for performance operations
